...
df.to_csv("results_may_27_2025.csv", index=False)
...
# WHERE td.tagging_date >= TIMESTAMP '2025-03-16 00:00:00'
# GROUP BY u.email
# ORDER BY u.email;
...
# Returns all the tagging results and the content of each tweet, filetered by a specific user and in a defined time frame
# 
# SELECT 
#     td.*, 
#     t.content
...
# Returns all the tagging results and the content of each tweet
#
# SELECT 
#     tweets.content, 
#     tagging_results.tag_result AS sentiment,
...
# FROM taggers_decisions td
# JOIN users u ON td.tagged_by = u.user_id
# WHERE td.tagging_date >= TIMESTAMP '2025-04-10 00:00:00' AND tagging_date <= TIMESTAMP '2025-04-23 00:00:00'
# GROUP BY u.email
# ORDER BY u.email;